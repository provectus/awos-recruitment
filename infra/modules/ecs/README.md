...
| <a name="module_service_access_sg"></a> [service\_access\_sg](#module\_service\_access\_sg) | terraform-aws-modules/security-group/aws | 5.1.0 |

## Resources

| Name | Type |
|------|------|
| [aws_cloudwatch_log_group.task_definition](https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/cloudwatch_log_group) | resource |
| [aws_ecs_service.this](https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/ecs_service) | resource |
| [aws_ecs_task_definition.this](https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/ecs_task_definition) | resource |
...
| <a name="input_env"></a> [env](#input\_env) | Deployment environment name | `string` | n/a | yes |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | ID of the VPC for ECS resources | `string` | `""` | no |
