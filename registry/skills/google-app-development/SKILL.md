...
description: "This skill should be used when the user asks to \"build an Android app\", \"create a Composable\", \"set up an Android project\", \"review Android code\", \"refactor Android\", \"add a screen\", \"create a Wear OS app\", \"build for Android TV\", \"build for Android Auto\", \"build for Android Automotive\", \"adapt for Meta Quest\", \"build for Fire TV\", \"build for Fire Tablet\", \"set up Room database\", \"use DataStore\", \"persist data\", \"add database migration\", \"encrypt storage\", \"add in-app purchases\", \"integrate Google Play Billing\", \"add subscriptions\", \"write Android tests\", \"test ViewModel\", \"test Composable\", \"configure Android Lint\", \"add custom lint rule\", \"set up lint baseline\", or when generating any Kotlin code targeting Google/Android platforms (including AOSP-based devices). Provides Jetpack Compose-first best practices for UI, lifecycle, navigation, storage, billing, testing, Lint, and platform-specific guidance. Use together with `kotlin-development` for language fundamentals."
version: 0.1.0
---
